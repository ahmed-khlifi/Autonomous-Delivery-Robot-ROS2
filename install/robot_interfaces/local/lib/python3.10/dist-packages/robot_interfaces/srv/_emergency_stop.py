...
class Metaclass_EmergencyStop(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from robot_interfaces.srv import _emergency_stop
...
class EmergencyStop(metaclass=Metaclass_EmergencyStop):
    from robot_interfaces.srv._emergency_stop import EmergencyStop_Request as Request
    from robot_interfaces.srv._emergency_stop import EmergencyStop_Response as Response
